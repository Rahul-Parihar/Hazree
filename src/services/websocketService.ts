/**
 * WebSocket Service for Hazree Admin Portal
 * Handles real-time event streaming for attendance punches, shifts, and presence updates.
 */
        ...
        try {
          ...
          this.listeners.forEach((callback) => {
            try {
              ...
              console.error('Error in WS event callback:', err);
            }
          });
        } catch (e) {
          // Non-JSON message
