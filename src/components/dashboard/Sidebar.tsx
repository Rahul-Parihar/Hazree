      ...
      <div className="p-4 border-b border-slate-800/80">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2.5 min-w-0">
            {/* Small circular logo */}
            <div className="w-7 h-7 rounded-full bg-blue-600 p-0.5 flex items-center justify-center shrink-0 shadow-xs">
              <div className="w-full h-full bg-[#111622] rounded-full flex items-center justify-center">
                <span className="text-[10px] font-bold text-cyan-400">H</span>
              </div>
            </div>
