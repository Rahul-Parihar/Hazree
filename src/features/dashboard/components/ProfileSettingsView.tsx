...
export default function ProfileSettingsView() {
  ...
  const [fullName, setFullName] = useState(activeEmployee?.fullName || "Employee");
  const [email, setEmail] = useState(activeEmployee?.email || "employee@company.com");
  ...
  const [dob, setDob] = useState(activeEmployee?.dob || "1996-08-15");
          ...
          <div>
            ...
            {activeTab === "profile" && (
              <form onSubmit={handleSave} className="p-6 space-y-6 text-xs">
                ...
                {/* Organization & Employment Info Card */}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <h4 className="text-base font-bold text-slate-900">
                        {activeEmployee?.companyName || "Hazree Organization"}
                      </h4>
                    </div>
                  </div>

                  <div className="flex items-center gap-4 text-xs">
                    <div className="px-3 py-1.5 rounded-lg bg-white border border-blue-200 text-slate-700 shadow-xs">
                      <span className="text-[10px] text-slate-400 block">Department</span>
                      <span className="font-semibold">{activeEmployee?.department || "General"}</span>
                    </div>
                    <div className="px-3 py-1.5 rounded-lg bg-white border border-blue-200 text-slate-700 shadow-xs">
                      <span className="text-[10px] text-slate-400 block">Designation</span>
                      <span className="font-semibold">{activeEmployee?.designation || "Staff"}</span>
                    </div>
                  </div>
                </div>
