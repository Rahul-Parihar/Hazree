          ...
          <div className="p-5 bg-slate-50 border border-slate-200/90 rounded-2xl space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <button
                ...
                className={`p-3 rounded-2xl text-left border transition-all cursor-pointer ${formData.shiftCount === 1
              ...
              <button
                ...
                className={`p-3 rounded-2xl text-left border transition-all cursor-pointer ${formData.shiftCount === 2
                  ? 'bg-emerald-600 text-white border-emerald-600 shadow-md ring-2 ring-emerald-400/40'
                  : 'bg-white text-slate-700 border-slate-200 hover:border-slate-300'
                  }`}
              >
              ...
              <button
                ...
                className={`p-3 rounded-2xl text-left border transition-all cursor-pointer ${formData.shiftCount === 3
                  ? 'bg-emerald-600 text-white border-emerald-600 shadow-md ring-2 ring-emerald-400/40'
                  : 'bg-white text-slate-700 border-slate-200 hover:border-slate-300'
                  }`}
              >
